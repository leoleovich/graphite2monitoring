...
// https://graphite.innogames.de/render?width=462&from=09%3A00_20140913&until=17%3A00_20140913&height=300&areaMode=stacked&target=aliasByNode(scale(sumSeries(servers.aw-graphite01.software.graphite.statuscodes.*)%2C%200.01666666666667)%2C%201)&target=aliasByNode(scale(sumSeries(servers.aw-graphite02.software.graphite.statuscodes.*)%2C%200.01666666666667)%2C%201)&target=aliasByNode(scale(sumSeries(servers.aw-gentime01.software.graphite.statuscodes.*)%2C%200.01666666666667)%2C%201)&title=Graphite%20RPS&_uniq=0.5935175532940775
